...
For deployments, visit [Releases](https://github.com/watamario15/formsclient/releases) and the [web deployment](https://watamario15.github.io/formsclient).

This is an university course project to evaluate the pair-programming among [watamario15](https://github.com/watamario15), [Nishidaaaa](https://github.com/Nishidaaaa), and [mittu205](https://github.com/mittu205). **NOT FOR A PRACTICAL USE.**
...
Accumulated answers that the server sends to us (not implemented):
